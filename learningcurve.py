...
parser.add_argument('-L', '--log', action='extend', default=[], type=int, nargs='*', help='Sets the y-axis of the given plot to log scale. Can be used multiple times.', metavar=('PLOT'))
...
for c in range(numCols):
    ...
    if args.log != None and c in args.log:        
